...
function HeaderListProducts() {
  ...
  const { cartItems, subtotal, totalItems, setIsOpen, isOpen } =
  ...
  return (
    <div className="relative h-[350px] w-full text-white overflow-hidden">
      {/* Background */}
      <div
        className="absolute inset-0 bg-center bg-cover"
        style={{
          backgroundImage:
            "url('https://www.bobswatches.com/images/managed/cartier-tank-vs-santos-hero.jpg')",
        }}
      />
...
${scrolled ? "bg-white text-black shadow-sm" : "bg-transparent text-white"}`}
      >
        ...
        {/* navigation */}
        <nav
          className={`flex justify-center gap-10 mt-6 text-[13px] tracking-[0.25em] 
      ...
      <div className="relative z-40 flex justify-between items-end h-full px-20 pb-10">
        {/* LEFT: WATCHES */}
        <h1 className="text-3xl tracking-widest font-light">WATCHES</h1>
